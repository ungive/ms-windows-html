...
function Window(options) {
  ...
  // Accessors for the x position of the window.
  this.define('x', {
    get: function ()      { return parseFloat(frame.style['margin-left']); },
    set: function (value) { frame.style['margin-left'] = value + 'px'; }
  });

  // Accessors for the y position.
  this.define('y', {
    get: function ()      { return parseFloat(frame.style['margin-top']); },
    set: function (value) { frame.style['margin-top'] = value + 'px'; }
  });
